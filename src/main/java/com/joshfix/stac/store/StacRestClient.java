...
import com.joshfix.stac.utility.JsonUtils;
...
public class StacRestClient {
    ...
    private final Logger LOGGER = Logger.getLogger(StacRestClient.class.getName());
...
*/
    ...
    private OkHttpClient.Builder configureToIgnoreCertificate(OkHttpClient.Builder builder) {
        LOGGER.fine("Ignore Ssl Certificate");
        try {
            ...
            LOGGER.fine("Exception while configuring IgnoreSslCertificate" + e);
        }
        return builder;
    }
